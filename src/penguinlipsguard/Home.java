    ...
    private void popup() {
        ...
        if (file.length() < inival) {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                Connection con = db.getConnection();
                Statement stmt=con.createStatement();  
                stmt.executeUpdate("CREATE TABLE `penguinlipssafe`.`data` ( `id` INT(10) NOT NULL , `domain` VARCHAR(20) NULL DEFAULT NULL , `uname` VARCHAR(20) NULL DEFAULT NULL , `email` VARCHAR(20) NULL DEFAULT NULL , `pwd` VARCHAR(20) NULL DEFAULT NULL , `note` TEXT NULL DEFAULT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
